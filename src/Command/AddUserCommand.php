...
#[AsCommand(
    name: 'app:add-user',
    description: 'Attention cette commande créée de nouveau utilisateur: risque de perte de données',
)]
...
final class AddUserCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addArgument('full-name', InputArgument::OPTIONAL, 'Nom de l\'utilisateur')
            ...
            ->addOption('admin', null, InputOption::VALUE_NONE, 'Si utilisateur est créé par un administrateur')
        ;
    }
    ...
    protected function interact(InputInterface $input, OutputInterface $output): void
    {
        ...
        $this->io->text([
            ...
            'Fournissez les arguments requis par la ligne de commande suivante',
            '',
            'symfony console app:add-user username password email@example.com',
            '',
            'Maintenant je vous demanderais tous les arguments manquants'
        ]);
        ...
        if (null !== $password) {
            ...
            $password = $this->io->askHidden('password', null, $this->validator->validatePassword(...));
        ...
        if (null !== $fullName) {
            $this->io->text('> <info>Nom complet</info>: ' . $email);
        } else {
